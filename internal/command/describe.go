...
// NewDescribeCommand implements 'kn-sink-kamelet describe' command
...
func writeKamelet(dw printers.PrefixWriter, kamelet *camelkv1.Kamelet, printDetails bool) {
...
func writeKameletProperties(dw printers.PrefixWriter, kamelet *camelkv1.Kamelet) {
...
func getMaxPropertyNameLen(properties map[string]camelkv1.JSONSchemaProp) string {
	max := 0
...
func asApiConditions(conditions []camelkv1.KameletCondition) apis.Conditions {
